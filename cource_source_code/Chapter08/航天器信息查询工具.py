class Search:
    info =  [{'天问一号': {'时间': '2020年', '简介': '天问一号是我国自行研制的'
            '探测器，负责执行我国第一次自主火星探测任务。'}},
    {'长征十一号海射运载火箭': {'时间': '2015年','简介': '长征十一号运载'
    '火箭是我国自主研制的一型四级全固体运载火箭， 主要用于快速机动发射应急卫星，'
    '满足自然灾害、突发事件等应急悄况下微小卫星发射需求。'}},
   {'长征五号B运载火箭': {'时间': '2020年','简介': '长征五号B运载火箭是'
    '专门为我国载人航天工程空间站建设而研制的一型新型运载火箭， 以长征五号火箭为基础'
    '改进而成，是我国近地轨道运载能力最大的新一代运载火箭。'}}]
